...
- **OpenAI / Anthropic session cost.** Official direct API models show `OpenAI Session Cost ≈$0.42` or `Anthropic Session Cost ≈$0.68`; the total includes main and every subagent, names its session scope, and never pretends to be a balance or server bill.
