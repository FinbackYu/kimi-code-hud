 ...
 * count while orchestration (swarm or tower) is running — or while a main
 * blocked in a single Agent tool call (non-orchestrated turn still open) is
 * still counted. A lone member is singular ("1 agent").
