...
| Kimi Code 宿主 | 源码与合成 fixture 基线 **2.1.0**；真实 TUI 验收待完成 | 逐版本契约审计与固定的上游提交见 [CAPABILITIES.md](CAPABILITIES.md) |
...
- [能力清单](CAPABILITIES.md)：Kimi Code 2.1.0 第一行 slots 的覆盖情况、数据来源，以及已经可读但尚未展示的 Cache/token/goal/task/Git 等信息；
